...
function listen(options) {
  ...
  let amqp_host = "hpfx.collab.science.gc.ca";
  let amqp_port = 5671;
  ...
  connection.on("ready", () => {
    connection.queue(
      ...
      q => {
        ...
        //let utcDateString = utcDate.getUTCFullYear() + String(Number(utcDate.getUTCMonth()) + 1).padStart(2, 0) + (utcDate.getUTCDate()).padStart(2,0);
